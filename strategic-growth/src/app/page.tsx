        ...
        <main className="capitalize text-center grid md:grid-flow-col lg:grid-flow-col gap-10">
            <section className="place-self-center mt-16 px-10 md:m-0">
                ...
                <span className="my-4 font-semibold">
                    getting started with strategic growth <br /> limited
                </span>
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <input type="email" placeholder="Email" className="text-black p-2 bg-slate-50" />
                    <input type="password" placeholder="Password" className="text-black p-2 bg-slate-50" />
                    <input type="password" placeholder="Confirm password" className="text-black p-2 bg-slate-50" />
                ...
                <div className="my-6">
                    already have an acount <a href="" className="text-blue-700  font-bold border-b-4">sign in</a>
                </div>
                <div className="my-6">
                    <small>by continuing you indicate that you read and <br /> agree to the teams and condition </small>
                </div>
            </section>
            <section>

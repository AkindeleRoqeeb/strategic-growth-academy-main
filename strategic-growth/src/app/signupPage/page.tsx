    ...
    return (
        ...
        ">
            <div className=" mx-10  place-content-center text-center pt-60">
                <h2 className="text-center text-2xl font-bold">welcome to strategic growth</h2>
                <div className="p-3" >
                <span className="text-xl font-normal gap-7 ">login into your account</span>
                    ...
                    <div className="grid gap-4">
                        ...
                        <input type="submit" className="p-4 bg-blue-950 w-96 rounded-md" />
                    </div>
                </div>
            </div>
            <div>
            <Image className="" src={Logoimage} alt="" style={{height: "80%", marginTop: "100px"}} />
            </div>
        </main>
    )
}